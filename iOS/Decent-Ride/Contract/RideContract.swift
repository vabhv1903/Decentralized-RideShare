...
//  Decent-Ride
//
//  Created by Mitchell Tucker on 1/28/21.
//
...
public class RideContract{
    ...
    init(wallet:Wallet){
        ...
        if network == .rinkeby{
            ...
            contractAddress = EthereumAddress("", ignoreChecksum: true)!
        ...
        do {
            ...
            rawContract = web3!.contract(contractAbi3, at: contractAddress!, abiVersion: abiVersion)!
            
            keystoreManager = getKeyStoreManager(wallet: wallet)
            web3!.addKeystoreManager(keystoreManager)
        }catch{
            print ("Falied to Init RideContract do to \(error)")
        }
    }
     ...
     */
    // TODO: This method should throw if WriteTransction is nil
